...
var outputContractCoverageInventory = map[string]outputContractCoverageEntry{
	"runtime_context":          {Variants: []string{"success"}},
	...
	"request_receipt":          {Variants: []string{"success"}},
	"file_replace":             {Variants: []string{"success"}},
	"file_patch":               {Variants: []string{"success"}},
	"file_add":                 {Variants: []string{"success"}},
	"file_delete":              {Variants: []string{"success"}},
	"file_move":                {Variants: []string{"success"}},
	...
	"acp_start":                {Variants: []string{"success"}},
	"acp_resume":               {Variants: []string{"success"}},
	"acp_status":               {Variants: []string{"success"}},
	"acp_stop":                 {Variants: []string{"success"}},
	...
	"work_on_project":    {Variants: []string{"success"}},
	"coding_task":        {Variants: []string{"success"}},
	"git_status":         {Variants: []string{"success"}},
	"git_diff":           {Variants: []string{"success"}},
	"git_changed_files":  {Variants: []string{"success"}},
	"git_commits":        {Variants: []string{"success"}},
	"git_branches":       {Variants: []string{"success"}},
	"git_worktree":       {Variants: []string{"list"}},
	"git_commit":         {Variants: []string{"success"}},
	"validation_run":     {Variants: []string{"success"}},
	"finish_coding_task": {Variants: []string{"success"}},
	"lsp_manage":         {Variants: []string{"discover"}},
...
func TestOutputContractCoverageGuardDetectsMissingAndInvalidEntries(t *testing.T) {
	...
	delete(inventory, "runtime_context")
	...
	for _, want := range []string{
		"runtime_context: missing coverage",
